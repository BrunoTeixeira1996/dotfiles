...
(custom-set-variables
 ...
 '(package-selected-packages
   '(exec-path-from-shell go-mode csharp-mode magit zenburn-theme multiple-cursors python-mode auctex markdown-mode auto-complete gruber-darker-theme smex use-package))
